...
*/		
	...
	public static void getCountries(String str, long p) {
		
		int page =1;
		String response = "";
		try {
			response = sendGet(str, page);
		} catch (Exception e) {
		...
		long total= (Long)jsonObject.get("total_pages");
	...
	private static String sendGet(String substr,int num) throws Exception {

		String url = "https://jsonmock.hackerrank.com/api/countries/search?name="+substr+"&page="+num;;
		URL obj = new URL(url);
